...
class ObjDict(dict):
    ...
    def __getitem__(self, key):
        item = super(ObjDict, self).__getitem__(key)
...
def sort_versions(versions, reverse=False):
    """Sort a list of versions in a natural order.

    This function will sort a list of versions in a natural order, so that
    '1.10' comes after '1.9' and not after '1.1'.
